...
/**
 * Used to initialize a single elastic node. For performance reasons (node startup costs), same instance is usually
 ...
 */
public class EmbeddedElasticsearchPolicy extends ExternalResource {
