 ...
 * {@link com.qihoo.qsql.org.apache.calcite.rel.RelNode relational expression}.</p>
 *
 * <p>Interface {@link com.qihoo.qsql.org.apache.calcite.plan.RelOptPlanner} defines a planner,
 * and class {@link com.qihoo.qsql.org.apache.calcite.plan.volcano.VolcanoPlanner} is an
 * implementation which uses a dynamic programming technique. It is based upon
 * the Volcano optimizer [<a href="#graefe93">1</a>].</p>
 *
 * <p>Interface {@link com.qihoo.qsql.org.apache.calcite.plan.RelOptCost} defines a cost
 * model; class {@link com.qihoo.qsql.org.apache.calcite.plan.volcano.VolcanoCost} is
 * the implementation for a <code>VolcanoPlanner</code>.</p>
 *
 * <p>A {@link com.qihoo.qsql.org.apache.calcite.plan.volcano.RelSet} is a set of equivalent
 ...
 * {@link com.qihoo.qsql.org.apache.calcite.plan.RelTraitDef}.  Manifestations of the trait
 * implement {@link com.qihoo.qsql.org.apache.calcite.plan.RelTrait}. The most common example
 * of a trait is calling convention: the protocol used to receive and transmit
 * data. {@link com.qihoo.qsql.org.apache.calcite.plan.ConventionTraitDef} defines the trait
 * and {@link com.qihoo.qsql.org.apache.calcite.plan.Convention} enumerates the
 * protocols. Every relational expression has a single calling convention by
 * which it returns its results. Some examples:</p>
 *
 * <ul>
 *     <li>{@link com.qihoo.qsql.org.apache.calcite.adapter.jdbc.JdbcConvention} is a fairly
 *         conventional convention; the results are rows from a
 *         {@link java.sql.ResultSet JDBC result set}.
 *     </li>
 *     <li>{@link com.qihoo.qsql.org.apache.calcite.plan.Convention#NONE} means that a
 *         relational
 *         expression cannot be implemented; typically there are rules which can
 *         transform it to equivalent, implementable expressions.
 *     </li>
 *     <li>{@link com.qihoo.qsql.org.apache.calcite.adapter.enumerable.EnumerableConvention}
 ...
 *     implementation of {@link com.qihoo.qsql.org.apache.calcite.rel.RelNode} should include
 *     its manifestation of the trait as part of the
 *     {@link com.qihoo.qsql.org.apache.calcite.plan.RelTraitSet} passed to
 *     {@link com.qihoo.qsql.org.apache.calcite.rel.AbstractRelNode}'s constructor. It may be
 ...
 *     {@link com.qihoo.qsql.org.apache.calcite.plan.volcano.VolcanoPlanner#setRoot(com.qihoo.qsql.org.apache.calcite.rel.RelNode)}
 ...
 * {@link com.qihoo.qsql.org.apache.calcite.rel.AbstractRelNode#clone()} must not assume the
 * type and quantity of traits in their trait set. In either case, the new
 * <code>RelTraitDef</code> implementation must be
 * {@link com.qihoo.qsql.org.apache.calcite.plan.volcano.VolcanoPlanner#addRelTraitDef(com.qihoo.qsql.org.apache.calcite.plan.RelTraitDef)}
 * registered with the planner.</p>
 *
 * <p>A {@link com.qihoo.qsql.org.apache.calcite.plan.volcano.RelSubset} is a subset of a
 ...
 * <ul>
 * <li>{@code <a href="../rel/package-summary.html">com.qihoo.qsql.org.apache.calcite.rel</a>}
 *     defines {@link com.qihoo.qsql.org.apache.calcite.rel.RelNode relational expressions}.
 * </li>
 * </ul>
 *
 * <h2>Details</h2>
 ...
 */
@PackageMarker
package com.qihoo.qsql.org.apache.calcite.plan.volcano;
