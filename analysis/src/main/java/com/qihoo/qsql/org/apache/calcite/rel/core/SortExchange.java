 ...
 * {@link com.qihoo.qsql.org.apache.calcite.rel.RelCollation} and an Exchange produces output
 * with a particular {@link com.qihoo.qsql.org.apache.calcite.rel.RelDistribution}, the output
...
public abstract class SortExchange extends Exchange {
  ...
  /**
   * Returns the array of {@link com.qihoo.qsql.org.apache.calcite.rel.RelFieldCollation}s
   * asked for by the sort specification, from most significant to least
   * significant.
   *
   * <p>See also
   * {@link com.qihoo.qsql.org.apache.calcite.rel.metadata.RelMetadataQuery#collations(RelNode)},
