 ...
 */
package com.qihoo.qsql.org.apache.calcite.util.trace;
...
import com.qihoo.qsql.org.apache.calcite.plan.RelImplementor;
...
public abstract class CalciteTrace {
  ...
  /**
   * The "com.qihoo.qsql.org.apache.calcite.sql.parser" tracer reports parser events in
   * {@link com.qihoo.qsql.org.apache.calcite.sql.parser.SqlParser} and other classes at DEBUG.
   */
  ...
  /**
   * The "com.qihoo.qsql.org.apache.calcite.plan.RelOptPlanner" tracer prints the query
  ...
  /**
   * The "com.qihoo.qsql.org.apache.calcite.prepare.Prepare" tracer prints the generated
  ...
  /**
   * The "com.qihoo.qsql.org.apache.calcite.rel.RelImplementorImpl" tracer reports when
  ...
  /**
   * The tracer "com.qihoo.qsql.org.apache.calcite.sql.timing" traces timing for
   * various stages of query processing.
   *
   * @see CalciteTimingTracer
   */
  public static Logger getSqlTimingTracer() {
    return LoggerFactory.getLogger("com.qihoo.qsql.org.apache.calcite.sql.timing");
  }

  /**
   * The "com.qihoo.qsql.org.apache.calcite.sql.parser" tracer reports parse events.
   */
  public static Logger getParserTracer() {
    return LoggerFactory.getLogger("com.qihoo.qsql.org.apache.calcite.sql.parser");
  }
