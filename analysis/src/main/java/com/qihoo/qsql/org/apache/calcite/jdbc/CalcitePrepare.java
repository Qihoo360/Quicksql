...
import com.qihoo.qsql.org.apache.calcite.sql.validate.CyclicDefinitionException;
...
public interface CalcitePrepare {
   ...
   * {@link com.qihoo.qsql.org.apache.calcite.jdbc.CalcitePrepare.ParseResult#kind} field. */
  ...
  class Dummy {
    ...
    private static SparkHandler createHandler() {
      try {
        final Class<?> clazz =
            Class.forName("com.qihoo.qsql.org.apache.calcite.adapter.spark.SparkHandlerImpl");
