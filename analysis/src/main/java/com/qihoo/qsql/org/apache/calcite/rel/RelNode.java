...
import com.qihoo.qsql.org.apache.calcite.plan.RelOptNode;
import com.qihoo.qsql.org.apache.calcite.plan.RelOptPlanner;
import com.qihoo.qsql.org.apache.calcite.plan.RelOptQuery;
 ...
 * {@link com.qihoo.qsql.org.apache.calcite.sql.SqlNode} and {@link RexNode}.</p>
 *
 ...
 * a {@link com.qihoo.qsql.org.apache.calcite.plan.RelImplementor} to manage the process. Every
 ...
 * RelNode. For example,
 * {@code com.qihoo.qsql.org.apache.calcite.adapter.enumerable.EnumerableRel}
 * has operations to manage the conversion to a graph of
 * {@code com.qihoo.qsql.org.apache.calcite.adapter.enumerable.EnumerableConvention}
...
public interface RelNode extends RelOptNode, Cloneable {
   ...
   *
   * @deprecated use #accept(com.qihoo.qsql.org.apache.calcite.rex.RexShuttle)
   * @return List of this relational expression's child expressions
   * @see #accept(com.qihoo.qsql.org.apache.calcite.rex.RexShuttle)
   */
   ...
   *
   * <p>Note: only {@link com.qihoo.qsql.org.apache.calcite.rel.core.Correlate} should set
   * variables.
   *
   ...
   * {@link com.qihoo.qsql.org.apache.calcite.util.Glossary#VISITOR_PATTERN visitor pattern} to
   ...
   * {@link com.qihoo.qsql.org.apache.calcite.rel.externalize.RelWriterImpl#input(String, RelNode)}
   * and
   * {@link com.qihoo.qsql.org.apache.calcite.rel.externalize.RelWriterImpl#item(String, Object)}
   ...
   * com.qihoo.qsql.org.apache.calcite.rel.ArrayRel.ArrayReader</code>, this method returns
   * "ArrayReader".
   *
   ...
   * {@link com.qihoo.qsql.org.apache.calcite.plan.RelOptPlanner#addRule} for each rule, and
