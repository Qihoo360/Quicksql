...
public class JsonLattice {
   ...
   * {@link com.qihoo.qsql.org.apache.calcite.materialize.LatticeStatisticProvider} interface.
   *
   * <p>Or, you can use a class name plus a static field, for example
   * "com.qihoo.qsql.org.apache.calcite.materialize.Lattices#CACHING_SQL_STATISTIC_PROVIDER".
   *
