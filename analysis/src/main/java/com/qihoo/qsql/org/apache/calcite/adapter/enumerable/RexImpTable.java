...
import static com.qihoo.qsql.org.apache.calcite.linq4j.tree.ExpressionType.Add;
import static com.qihoo.qsql.org.apache.calcite.linq4j.tree.ExpressionType.AndAlso;
import static com.qihoo.qsql.org.apache.calcite.linq4j.tree.ExpressionType.Divide;
import static com.qihoo.qsql.org.apache.calcite.linq4j.tree.ExpressionType.Equal;
import static com.qihoo.qsql.org.apache.calcite.linq4j.tree.ExpressionType.GreaterThan;
import static com.qihoo.qsql.org.apache.calcite.linq4j.tree.ExpressionType.GreaterThanOrEqual;
import static com.qihoo.qsql.org.apache.calcite.linq4j.tree.ExpressionType.LessThan;
import static com.qihoo.qsql.org.apache.calcite.linq4j.tree.ExpressionType.LessThanOrEqual;
import static com.qihoo.qsql.org.apache.calcite.linq4j.tree.ExpressionType.Multiply;
import static com.qihoo.qsql.org.apache.calcite.linq4j.tree.ExpressionType.Negate;
import static com.qihoo.qsql.org.apache.calcite.linq4j.tree.ExpressionType.Not;
import static com.qihoo.qsql.org.apache.calcite.linq4j.tree.ExpressionType.NotEqual;
import static com.qihoo.qsql.org.apache.calcite.linq4j.tree.ExpressionType.OrElse;
import static com.qihoo.qsql.org.apache.calcite.linq4j.tree.ExpressionType.Subtract;
import static com.qihoo.qsql.org.apache.calcite.linq4j.tree.ExpressionType.UnaryPlus;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.OracleSqlOperatorTable.TRANSLATE3;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.ABS;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.ACOS;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.AND;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.ANY_VALUE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.ARRAY_VALUE_CONSTRUCTOR;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.ASIN;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.ATAN;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.ATAN2;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.CARDINALITY;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.CASE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.CAST;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.CEIL;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.CHARACTER_LENGTH;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.CHAR_LENGTH;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.COALESCE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.COLLECT;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.CONCAT;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.COS;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.COT;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.COUNT;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.CURRENT_CATALOG;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.CURRENT_DATE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.CURRENT_PATH;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.CURRENT_ROLE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.CURRENT_TIME;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.CURRENT_TIMESTAMP;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.CURRENT_USER;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.CURRENT_VALUE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.DATEDIFF;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.DATETIME_PLUS;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.DATE_ADD;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.DATE_SUB;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.DEFAULT;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.DEGREES;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.DENSE_RANK;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.DIVIDE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.DIVIDE_INTEGER;
...
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.FROM_UNIXTIME;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.FUSION;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.GREATER_THAN;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.GREATER_THAN_OR_EQUAL;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.GROUPING;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.GROUPING_ID;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.GROUP_ID;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.IF;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.INITCAP;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.IS_A_SET;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.IS_EMPTY;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.IS_FALSE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.IS_NOT_A_SET;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.IS_NOT_EMPTY;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.IS_NOT_FALSE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.IS_NOT_NULL;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.IS_NOT_TRUE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.IS_NULL;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.IS_TRUE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.ITEM;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.LAG;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.LAST_VALUE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.LEAD;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.LENGTH;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.LESS_THAN;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.LESS_THAN_OR_EQUAL;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.LIKE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.LN;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.LOCALTIME;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.LOCALTIMESTAMP;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.LOG10;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.LOWER;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.MAP_VALUE_CONSTRUCTOR;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.MAX;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.MEMBER_OF;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.MIN;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.MINUS;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.MINUS_DATE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.MOD;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.MULTIPLY;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.MULTISET_EXCEPT;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.MULTISET_EXCEPT_DISTINCT;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.MULTISET_INTERSECT;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.MULTISET_INTERSECT_DISTINCT;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.MULTISET_UNION;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.MULTISET_UNION_DISTINCT;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.NEXT_VALUE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.NOT;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.NOT_EQUALS;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.NOT_LIKE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.NOT_SIMILAR_TO;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.NOT_SUBMULTISET_OF;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.NTH_VALUE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.NTILE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.OR;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.OVERLAY;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.PI;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.PLUS;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.POSITION;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.POWER;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.RADIANS;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.RAND;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.RAND_INTEGER;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.RANK;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.REFLECT;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.REGEXP_EXTRACT;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.REGEXP_REPLACE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.REGR_COUNT;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.REINTERPRET;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.REPLACE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.REVERSE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.ROUND;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.ROW;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.ROW_NUMBER;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.SESSION_USER;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.SIGN;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.SIMILAR_TO;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.SIN;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.SINGLE_VALUE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.SLICE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.SPLIT;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.STRING_CONCAT;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.SUBMULTISET_OF;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.SUBSTR;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.SUBSTRING;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.SUBSTRING_INDEX;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.SUM;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.SUM0;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.SYSTEM_USER;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.TAN;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.TRIM;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.TRUNCATE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.UNARY_MINUS;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.UNARY_PLUS;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.UNIX_TIMESTAMP;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.UPPER;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.URLDECODE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.URLENCODE;
import static com.qihoo.qsql.org.apache.calcite.sql.fun.SqlStdOperatorTable.USER;
...
import com.qihoo.qsql.org.apache.calcite.linq4j.tree.BlockStatement;
...
import com.qihoo.qsql.org.apache.calcite.linq4j.tree.MemberExpression;
...
import com.qihoo.qsql.org.apache.calcite.linq4j.tree.UnaryExpression;
...
import com.qihoo.qsql.org.apache.calcite.schema.ImplementableAggFunction;
import com.qihoo.qsql.org.apache.calcite.schema.ImplementableFunction;
import com.qihoo.qsql.org.apache.calcite.schema.impl.AggregateFunctionImpl;
import com.qihoo.qsql.org.apache.calcite.sql.SqlAggFunction;
import com.qihoo.qsql.org.apache.calcite.sql.SqlBinaryOperator;
...
public class RexImpTable {
  ...
  RexImpTable() {
    ...
    defineMethod(SUBSTR, BuiltInMethod.SUBSTR.method, NullPolicy.STRICT);
    defineMethod(URLDECODE, BuiltInMethod.URLDECODE.method, NullPolicy.STRICT);
    defineMethod(URLENCODE, BuiltInMethod.URLENCODE.method, NullPolicy.STRICT);
    defineMethod(STRING_CONCAT, BuiltInMethod.STRING_CONCAT.method, NullPolicy.STRICT);
    defineMethod(SPLIT, BuiltInMethod.SPLIT.method, NullPolicy.STRICT);
    defineMethod(DATEDIFF, BuiltInMethod.DATEDIFF.method, NullPolicy.STRICT);
...
*/
  ...
  public CallImplementor get(final SqlOperator operator) {
    if (operator instanceof SqlUserDefinedFunction) {
      com.qihoo.qsql.org.apache.calcite.schema.Function udf =
