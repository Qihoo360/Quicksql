...
import com.qihoo.qsql.org.apache.calcite.linq4j.function.Deterministic;
import com.qihoo.qsql.org.apache.calcite.linq4j.function.NonDeterministic;
import com.qihoo.qsql.org.apache.calcite.linq4j.tree.Blocks;
import com.qihoo.qsql.org.apache.calcite.linq4j.tree.ClassDeclarationFinder;
import com.qihoo.qsql.org.apache.calcite.linq4j.tree.DeterministicCodeOptimizer;
...
public class DeterministicTest {
        ...
        BlockBuilderBase.optimize(
            Expressions.new_(
                ...
                Expressions.methodDecl(
                    ...
                    "test",
                    Collections.emptyList(),
                    Blocks.toFunctionBlock(Expressions.add(BlockBuilderBase.ONE, BlockBuilderBase.TWO))))),
        equalTo("{\n"
            + "  return new Runnable(){\n"
            + "      int test() {\n"
            + "        return $L4J$C$1_2;\n"
  ...
  @Test public void testFactorOutBinaryAddSurvivesMultipleOptimizations() {
    assertThat(
        BlockBuilderBase.optimize(
            BlockBuilderBase.optimizeExpression(
            ...
            Expressions.new_(
                ...
                Expressions.methodDecl(
                    ...
                    Blocks.toFunctionBlock(
                        Expressions.multiply(Expressions.add(BlockBuilderBase.ONE, BlockBuilderBase.TWO),
                            Expressions.subtract(BlockBuilderBase.ONE, BlockBuilderBase.TWO)))))),
        equalTo("{\n"
            + "  return new Runnable(){\n"
            + "      int test() {\n"
        ...
        BlockBuilderBase.optimize(
            Expressions.new_(
                ...
                Expressions.methodDecl(
                    ...
                    Blocks.toFunctionBlock(
                        Expressions.add(
                            Expressions.add(BlockBuilderBase.ONE, BlockBuilderBase.FOUR),
                            Expressions.call(
                                Expressions.new_(
                                    Callable.class,
                                    Collections.emptyList(),
                                    Expressions.methodDecl(
                                        ...
                                        Blocks.toFunctionBlock(
                                            Expressions.multiply(
                                                Expressions.add(BlockBuilderBase.ONE, BlockBuilderBase.TWO),
                                                BlockBuilderBase.THREE)))),
                                "call",
                                Collections.emptyList())))))),
        equalTo("{\n"
        ...
        BlockBuilderBase.optimize(
            Expressions.new_(
                ...
                Expressions.methodDecl(
                    ...
                    Collections.emptyList(),
                    Blocks.toFunctionBlock(
                        Expressions.typeIs(BlockBuilderBase.ONE, Boolean.class))))),
        equalTo("{\n"
            + "  return new Runnable(){\n"
            + "      int test() {\n"
            ...
            Expressions.new_(Runnable.class,
                ...
                Expressions.methodDecl(0, int.class, "test",
                    ...
                    Blocks.toFunctionBlock(
                        Expressions.orElse(
                            Expressions.typeIs(BlockBuilderBase.ONE, Boolean.class),
                            Expressions.typeIs(BlockBuilderBase.TWO, Integer.class)))))),
        equalTo("{\n"
            + "  return new Runnable(){\n"
            + "      int test() {\n"
  ...
  @Test public void testDeterministicMethodCall() {
    assertThat(
        ...
        equalTo("{\n"
            ...
            + "      }\n"
            + "\n"
            + "      static final int $L4J$C$org_apache_calcite_linq4j_test_DeterministicTest_TestClass_dete33e8af1c = DeterministicTest.TestClass.deterministic(1);\n"
            + "    };\n"
            + "}\n"));
  }
  ...
  @Test public void testNonDeterministicMethodCall() {
    assertThat(
        ...
        equalTo("{\n"
            + "  return new Runnable(){\n"
            + "      int test() {\n"
            + "        return DeterministicTest.TestClass.nonDeterministic(1);\n"
            + "      }\n"
            + "\n"
            + "    };\n"
            + "}\n"));
  ...
  @Test public void testDeterministicClassDefaultMethod() {
    assertThat(
        ...
        equalTo("{\n"
            ...
            + "      }\n"
            + "\n"
            + "      static final int $L4J$C$org_apache_calcite_linq4j_test_DeterministicTest_TestDeterminis9de610da = DeterministicTest.TestDeterministicClass.deterministic(1);\n"
            + "    };\n"
            + "}\n"));
  }
  ...
  @Test public void testDeterministicClassNonDeterministicMethod() {
    assertThat(
        ...
        equalTo("{\n"
            + "  return new Runnable(){\n"
            + "      int test() {\n"
            + "        return DeterministicTest.TestDeterministicClass.nonDeterministic(1);\n"
            + "      }\n"
            + "\n"
            + "    };\n"
            + "}\n"));
