...
import com.qihoo.qsql.org.apache.calcite.linq4j.tree.DeclarationStatement;
...
import com.qihoo.qsql.org.apache.calcite.linq4j.tree.FieldDeclaration;
...
import com.qihoo.qsql.org.apache.calcite.linq4j.tree.Node;
...
public class ExpressionTest {
  ...
  @Test public void testWriteConstant() {
    ...
    // enum
    assertEquals(
        "ExpressionTest.MyEnum.X",
        Expressions.toString(
            Expressions.constant(MyEnum.X)));

    // array of enum
    assertEquals(
        "new ExpressionTest.MyEnum[] {\n"
            + "  ExpressionTest.MyEnum.X,\n"
            + "  ExpressionTest.MyEnum.Y}",
        Expressions.toString(
...
*/
    ...
    assertEquals(
        "{\n"
            ...
            + "  final int _c = 1 + 3;\n"
            + "  final int _d = 1 + 4;\n"
            + "  ExpressionTest.bar(1, _b, _c, _d, ExpressionTest.foo(_c));\n"
            + "}\n",
