...
import com.qihoo.qsql.org.apache.calcite.linq4j.Linq4j.CollectionEnumerable;
import com.qihoo.qsql.org.apache.calcite.linq4j.Linq4j.ListEnumerable;
...
import static com.qihoo.qsql.org.apache.calcite.linq4j.function.Functions.adapt;
...
public abstract class EnumerableDefaults {
  ...
  public static <TSource> double max(Enumerable<TSource> source,
      DoubleFunction1<TSource> selector) {
    return aggregate(source.select(Functions.adapt(selector)), null,
  ...
  public static <TSource> long max(Enumerable<TSource> source,
      LongFunction1<TSource> selector) {
    return aggregate(source.select(Functions.adapt(selector)), null, Extensions.LONG_MAX);
  }
  ...
  public static <TSource> long min(Enumerable<TSource> source,
      LongFunction1<TSource> selector) {
    return aggregate(source.select(Functions.adapt(selector)), null, Extensions.LONG_MIN);
  }
  ...
  public static <TSource> double sum(Enumerable<TSource> source,
      DoubleFunction1<TSource> selector) {
    return aggregate(source.select(Functions.adapt(selector)), 0d, Extensions.DOUBLE_SUM);
  }
  ...
  public static <TSource> int sum(Enumerable<TSource> source,
      IntegerFunction1<TSource> selector) {
    return aggregate(source.select(Functions.adapt(selector)), 0, Extensions.INTEGER_SUM);
  }
  ...
  public static <TSource> long sum(Enumerable<TSource> source,
      LongFunction1<TSource> selector) {
    return aggregate(source.select(Functions.adapt(selector)), 0L, Extensions.LONG_SUM);
  }
  ...
  public static <TSource> float sum(Enumerable<TSource> source,
      FloatFunction1<TSource> selector) {
    return aggregate(source.select(Functions.adapt(selector)), 0F, Extensions.FLOAT_SUM);
  }
