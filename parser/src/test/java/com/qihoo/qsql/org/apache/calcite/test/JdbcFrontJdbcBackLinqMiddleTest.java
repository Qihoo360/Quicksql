...
import static com.qihoo.qsql.org.apache.calcite.test.CalciteAssert.that;
...
public class JdbcFrontJdbcBackLinqMiddleTest {
  ...
  @Test public void testPlan3() {
    ...
    that()
        ...
        .planContains(
            " left.hashJoin(right, new com.qihoo.qsql.org.apache.calcite.linq4j.function.Function1() {\n");
  }
}
