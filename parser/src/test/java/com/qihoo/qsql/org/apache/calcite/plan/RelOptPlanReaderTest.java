...
import com.qihoo.qsql.org.apache.calcite.rel.externalize.RelJson;
...
public class RelOptPlanReaderTest {
  @Test public void testTypeToClass() {
    ...
    // in com.qihoo.qsql.org.apache.calcite.rel package
    ...
    // in com.qihoo.qsql.org.apache.calcite.adapter.jdbc.JdbcRules outer class
    ...
    try {
      Class clazz =
          relJson.typeNameToClass("com.qihoo.qsql.org.apache.calcite.rel.NonExistentRel");
      fail("expected exception, got " + clazz);
    } catch (RuntimeException e) {
      assertThat(e.getMessage(),
          is("unknown type com.qihoo.qsql.org.apache.calcite.rel.NonExistentRel"));
    }

    // In this class; no special treatment. Note: '$MyRel' not '.MyRel'.
    assertThat(relJson.classToTypeName(MyRel.class),
        is("com.qihoo.qsql.org.apache.calcite.plan.RelOptPlanReaderTest$MyRel"));
    ...
    try {
      ...
      assertThat(e.getMessage(),
          is(
              "unknown type com.qihoo.qsql.org.apache.calcite.plan.RelOptPlanReaderTest.MyRel"));
    }
  }
