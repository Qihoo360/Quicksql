...
import static com.qihoo.qsql.org.apache.calcite.test.JdbcTest.Employee;
...
public class ReflectiveSchemaTest {
   ...
   * {@link com.qihoo.qsql.org.apache.calcite.linq4j.QueryProvider}.
   *
   ...
   * The function returns a {@link com.qihoo.qsql.org.apache.calcite.linq4j.Queryable}.
   */
  @Ignore
  ...
  @Test public void testDivideWraperWrapper() throws Exception {
    ...
    with.query("select \"wrapperLong\" / \"wrapperLong\" as c\n"
        + " from \"s\".\"everyTypes\" where \"primitiveLong\" <> 0")
        .planContains(
            "final Long inp13_ = ((com.qihoo.qsql.org.apache.calcite.test.ReflectiveSchemaTest.EveryType) inputEnumerator.current()).wrapperLong;")
        .planContains(
            "return inp13_ == null ? (Long) null "
  ...
  @Test public void testReflectiveSchemaInUnnamedPackage() throws Exception {
    ...
    try (CalciteConnection connection = (CalciteConnection)
      ...
      final Class<?> c = Class.forName("com.qihoo.qsql.org.apache.calcite.RootHr");
