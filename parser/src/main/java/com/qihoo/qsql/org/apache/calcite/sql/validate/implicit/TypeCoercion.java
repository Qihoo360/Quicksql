...
public interface TypeCoercion {
   ...
   * {@link com.qihoo.qsql.org.apache.calcite.rel.type.RelDataTypeSystem}.
   */
   ...
   * {@link com.qihoo.qsql.org.apache.calcite.sql.type.FamilyOperandTypeChecker}.
   *
   * <p>Caution that we do not cast from numeric if desired type family is also
   * {@link SqlTypeFamily#NUMERIC}.
   *
   * <p>If the {@link com.qihoo.qsql.org.apache.calcite.sql.type.FamilyOperandTypeChecker}s are
   * subsumed in a
   * {@link com.qihoo.qsql.org.apache.calcite.sql.type.CompositeOperandTypeChecker}, check them
