...
import static com.qihoo.qsql.org.apache.calcite.adapter.druid.DruidQuery.writeField;
import static com.qihoo.qsql.org.apache.calcite.adapter.druid.DruidQuery.writeFieldIf;
...
public class ExtractionDimensionSpec implements DimensionSpec {
  ...
  public ExtractionDimensionSpec(String dimension, ExtractionFunction extractionFunction,
      String outputName) {
    this.dimension = Preconditions.checkNotNull(dimension.toLowerCase());
