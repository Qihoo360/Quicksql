...
public class RelOptMaterialization {
   ...
   * {@link com.qihoo.qsql.org.apache.calcite.schema.impl.StarTable}.
   *
   * <p>The relational expression is already in leaf-join-form, per
   * {@link #toLeafJoinForm(com.qihoo.qsql.org.apache.calcite.rel.RelNode)}.
   *
  ...
  public static RelNode tryUseStar(RelNode rel,
    ...
    RelNode rel2 = rel.accept(
        new RelShuttleImpl() {
          ...
          /** Throws a {@link com.qihoo.qsql.org.apache.calcite.util.Util.FoundOne} containing
           * a {@link com.qihoo.qsql.org.apache.calcite.rel.logical.LogicalTableScan} on
   ...
   * {@link com.qihoo.qsql.org.apache.calcite.rel.logical.LogicalJoin}s are
