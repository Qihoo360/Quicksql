...
import com.qihoo.qsql.org.apache.calcite.adapter.enumerable.EnumerableAggregate;
import com.qihoo.qsql.org.apache.calcite.adapter.enumerable.EnumerableFilter;
...
import com.qihoo.qsql.org.apache.calcite.interpreter.JaninoRexCompiler;
...
import com.qihoo.qsql.org.apache.calcite.rel.stream.LogicalChi;
    ...
    for (Ord<Method> method : Ord.zip(def.methods)) {
      ...
      buff.append("    final java.util.List key = ")
          .append(
              ...
              ? com.qihoo.qsql.org.apache.calcite.runtime.FlatLists.class
