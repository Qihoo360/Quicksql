 ...
 * {@link com.qihoo.qsql.org.apache.calcite.adapter.enumerable.AggImplementor#implementAdd(AggContext, AggAddContext)}.
 *
...
public interface AggAddContext extends AggResultContext {
  /**
   * Returns {@link com.qihoo.qsql.org.apache.calcite.rex.RexNode} representation of arguments.
   * This can be useful for manual translation of required arguments with
   * different {@link NullPolicy}.
   * @return {@link com.qihoo.qsql.org.apache.calcite.rex.RexNode} representation of arguments
   */
  List<RexNode> rexArguments();

  /**
   * Returns {@link com.qihoo.qsql.org.apache.calcite.rex.RexNode} representation of the
   * filter, or null.
   */
  ...
  /**
   * Returns a
   * {@link com.qihoo.qsql.org.apache.calcite.adapter.enumerable.RexToLixTranslator}
