...
import com.qihoo.qsql.org.apache.calcite.adapter.jdbc.JdbcTable;
...
//    }
  ...
  /**
   * Gets the {@link com.qihoo.qsql.org.apache.calcite.rel.rel2sql.SqlImplementor.Builder} for
  ...
  //Updated by qsql-team, something different from 1.16
  /** @see #dispatch */
  ...
  //Modified by QSQL.
  public Result visit(DruidQuery e) {
    return visit(e.getTableScan());
  }
