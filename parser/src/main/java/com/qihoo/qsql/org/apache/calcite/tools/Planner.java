...
public interface Planner extends AutoCloseable {
   ...
   * @throws com.qihoo.qsql.org.apache.calcite.sql.parser.SqlParseException on parse error
   */
   ...
   *
   * <p>You must call {@link #validate(com.qihoo.qsql.org.apache.calcite.sql.SqlNode)} first.
   *
   * @param sql The root node of the SQL parse tree.
   * @return The root node of the newly generated RelNode tree.
   * @throws com.qihoo.qsql.org.apache.calcite.tools.RelConversionException if the node
   ...
   * @throws com.qihoo.qsql.org.apache.calcite.tools.RelConversionException on conversion
   *     error
   */
