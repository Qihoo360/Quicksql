 ...
 */
package com.qihoo.qsql.org.apache.calcite.sql.util;
...
public abstract class ReflectiveSqlOperatorTable implements SqlOperatorTable {
  ...
  public static class CaseInsensitiveKey extends Pair<String, SqlSyntax> {
    public CaseInsensitiveKey(String name, SqlSyntax syntax) {
  ...
  public static class CaseSensitiveKey extends Pair<String, SqlSyntax> {
    public CaseSensitiveKey(String name, SqlSyntax syntax) {
  ...
  //Updated by qsql-team
  public Multimap<CaseInsensitiveKey, SqlOperator> getOperators() {
    return caseInsensitiveOperators;
  }
}
