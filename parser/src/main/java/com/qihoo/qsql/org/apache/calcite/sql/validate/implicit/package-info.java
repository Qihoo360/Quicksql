 ...
 * {@link com.qihoo.qsql.org.apache.calcite.sql.type.AssignableOperandTypeChecker AssignableOperandTypeChecker},
 * {@link com.qihoo.qsql.org.apache.calcite.sql.type.ComparableOperandTypeChecker ComparableOperandTypeChecker}
 * {@link com.qihoo.qsql.org.apache.calcite.sql.type.CompositeOperandTypeChecker CompositeOperandTypeChecker},
 * {@link com.qihoo.qsql.org.apache.calcite.sql.type.FamilyOperandTypeChecker FamilyOperandTypeChecker},
 * {@link com.qihoo.qsql.org.apache.calcite.sql.type.SameOperandTypeChecker SameOperandTypeChecker},
 * {@link com.qihoo.qsql.org.apache.calcite.sql.type.SetopOperandTypeChecker SetopOperandTypeChecker}.
 *
 * <ul>
 *   <li>
 *     When user do validation for a {@link com.qihoo.qsql.org.apache.calcite.sql.SqlNode SqlNode},
 ...
 *     {@link com.qihoo.qsql.org.apache.calcite.sql.SqlNode SqlNode} it has validated;</li>
 *   <li>If the validation fails, the validator will ask the
 *   {@link com.qihoo.qsql.org.apache.calcite.sql.validate.implicit.TypeCoercion TypeCoercion} about
 *   if there can make implicit type coercion, if the coercion rules passed, the
 *   {@link com.qihoo.qsql.org.apache.calcite.sql.validate.implicit.TypeCoercion TypeCoercion} component
 *   will replace the {@link com.qihoo.qsql.org.apache.calcite.sql.SqlNode SqlNode} with a casted one,
 *   (the node may be an operand of an operator or a column field of a selected row).</li>
 *   <li>{@link com.qihoo.qsql.org.apache.calcite.sql.validate.implicit.TypeCoercion TypeCoercion}
 ...
 */
@PackageMarker
package com.qihoo.qsql.org.apache.calcite.sql.validate.implicit;
