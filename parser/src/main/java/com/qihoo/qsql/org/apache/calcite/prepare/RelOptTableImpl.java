...
import com.qihoo.qsql.org.apache.calcite.rel.RelDistributionTraitDef;
...
import com.qihoo.qsql.org.apache.calcite.schema.SchemaVersion;
...
import com.qihoo.qsql.org.apache.calcite.schema.TemporalTable;
...
/**
 * Implementation of {@link com.qihoo.qsql.org.apache.calcite.plan.RelOptTable}.
 */
public class RelOptTableImpl extends Prepare.AbstractPreparingTable {
  ...
  //Modified by QSQL, for creating RelOptTableImpl in program, names are apart from table
  ...
  //Modified by QSQL
  public RelOptTableImpl modifyTableName(List<String> names) {
    return new RelOptTableImpl(this.schema, this.rowType,
        ImmutableList.copyOf(names), this.table,
  ...
  private static class MySchemaPlus implements SchemaPlus {
    ...
    @Override public void add(String name,
        com.qihoo.qsql.org.apache.calcite.schema.Function function) {
      throw new UnsupportedOperationException();
    }
    ...
    @Override public Collection<com.qihoo.qsql.org.apache.calcite.schema.Function>
