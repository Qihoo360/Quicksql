...
import com.qihoo.qsql.org.apache.calcite.runtime.Unit;
...
import com.qihoo.qsql.org.apache.calcite.sql.type.JavaToSqlTypeConversionRules;
...
public class JavaTypeFactoryImpl
   ...
   *
   * <p>Takes into account {@link com.qihoo.qsql.org.apache.calcite.adapter.java.Array}
   * annotations if present.
   */
  private Type fieldType(Field field) {
    final Class<?> klass = field.getType();
    final com.qihoo.qsql.org.apache.calcite.adapter.java.Array array =
        field.getAnnotation(com.qihoo.qsql.org.apache.calcite.adapter.java.Array.class);
    if (array != null) {
      return new Types.ArrayType(array.component(), array.componentIsNullable(),
          array.maximumCardinality());
    }
    final com.qihoo.qsql.org.apache.calcite.adapter.java.Map map =
        field.getAnnotation(com.qihoo.qsql.org.apache.calcite.adapter.java.Map.class);
    if (map != null) {
  ...
  public RelDataType getDataType(RelDataTypeFactory relDataTypeFactory, String javaType) {
    switch (javaType.toUpperCase()) {
      ...
      case "ARRAY":
        return relDataTypeFactory.createSqlType(SqlTypeName.ARRAY);
      case "MAP":
