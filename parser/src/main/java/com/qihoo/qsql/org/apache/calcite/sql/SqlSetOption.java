...
public class SqlSetOption extends SqlAlter {
  ...
  /** Name of the option as an {@link com.qihoo.qsql.org.apache.calcite.sql.SqlIdentifier}
   * with one or more parts.*/
  SqlIdentifier name;

  /** Value of the option. May be a {@link com.qihoo.qsql.org.apache.calcite.sql.SqlLiteral} or
   * a {@link com.qihoo.qsql.org.apache.calcite.sql.SqlIdentifier} with one
