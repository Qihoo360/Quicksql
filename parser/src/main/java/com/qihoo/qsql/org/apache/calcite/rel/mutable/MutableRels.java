 ...
 */
package com.qihoo.qsql.org.apache.calcite.rel.mutable;
...
public abstract class MutableRels {
  ...
  /** Based on
   * {@link com.qihoo.qsql.org.apache.calcite.rel.rules.ProjectRemoveRule#strip}. */
  public static MutableRel strip(MutableProject project) {
    return isTrivial(project) ? project.getInput() : project;
  }

  /** Based on
   * {@link com.qihoo.qsql.org.apache.calcite.rel.rules.ProjectRemoveRule#isTrivial(com.qihoo.qsql.org.apache.calcite.rel.core.Project)}. */
  ...
  /** Equivalent to
   * {@link RelOptUtil#createProject(com.qihoo.qsql.org.apache.calcite.rel.RelNode, java.util.List)}
   * for {@link MutableRel}. */
  ...
  /** Equivalence to {@link com.qihoo.qsql.org.apache.calcite.plan.RelOptUtil#createCastRel}
   * for {@link MutableRel}. */
